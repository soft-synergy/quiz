...
const stepPage: Record<LangCode, StepPageTranslations> = {
  ...
  lt: {
    ...
    bmi_checking: "Skaičiuojame jūsų KMI. Tai padeda sukurti jūsų kūnui tinkamą planą.",
    bmi_underweight: (b) => "Jūsų KMI yra __BMI__, tai yra žemiau įprastos ribos".replace("__BMI__", String(b)),
    bmi_underweight_body: "Jums gali būti naudingi švelnūs stiprinimo pratimai ir subalansuota mityba.",
    bmi_normal: (b) => "Jūsų KMI yra __BMI__, tai yra sveika riba".replace("__BMI__", String(b)),
    bmi_normal_body: "Judate gera kryptimi. Tęskite savo rutiną.",
    bmi_overweight: (b) => "Jūsų KMI yra __BMI__, tai laikoma antsvoriu".replace("__BMI__", String(b)),
    bmi_overweight_body: "Jūsų svoriui reikia daugiau dėmesio. Pritaikysime planą pagal jūsų poreikius ir tikslus.",
    bmi_obese: (b) => "Jūsų KMI yra __BMI__, tai laikoma nutukimu".replace("__BMI__", String(b)),
    bmi_obese_body: "Jūsų svoris gali turėti įtakos sveikatai. Sukursime jums tinkamą planą.",
    goal_placeholder: "Įveskite tikslinį svorį, kad pamatytumėte asmenines rekomendacijas",
    goal_weight_too_high: "Tikslinis svoris turi būti mažesnis už dabartinį.",
    goal_too_low: "Jūsų tikslas gali būti per žemas jūsų kūnui. Sveikas KMI paprastai yra nuo 18,5 iki 24,9.",
    goal_a_lot: "Tai didelis tikslas, ir tai visiškai normalu. Padėsime jį pasiekti žingsnis po žingsnio.",
    goal_moderate: "Tai realus tikslas. Nuoseklus progresas gali pagerinti jūsų sveikatą.",
    goal_small: "Jūs jau arti savo tikslo. Net maži pokyčiai gali daug pakeisti.",
    consent_text: "Sutinku, kad mano sveikatos duomenys būtų naudojami asmeniniam planui sukurti.",
    consent_privacy_link: "Privatumo politika",
    char_count: (n) => "__N__/20".replace("__N__", String(n)),
  },
  lv: {
    error_range: (mn, mx, u) => "Lūdzu, ievadiet vērtību no __MIN__ līdz __MAX__ __UNIT__".replace("__MIN__", String(mn)).replace("__MAX__", String(mx)).replace("__UNIT__", String(u)),
    bmi_checking: "Aprēķinām jūsu ĶMI. Tas palīdz izveidot jūsu ķermenim piemērotu plānu.",
    bmi_underweight: (b) => "Jūsu ĶMI ir __BMI__, tas ir zem ierastā diapazona".replace("__BMI__", String(b)),
    bmi_underweight_body: "Jums var palīdzēt saudzīgi spēka vingrinājumi un sabalansēts uzturs.",
    bmi_normal: (b) => "Jūsu ĶMI ir __BMI__, tas ir veselīgā diapazonā".replace("__BMI__", String(b)),
    bmi_normal_body: "Jūs virzāties pareizajā virzienā. Turpiniet iesākto.",
    bmi_overweight: (b) => "Jūsu ĶMI ir __BMI__, tas tiek uzskatīts par lieko svaru".replace("__BMI__", String(b)),
    bmi_overweight_body: "Jūsu svaram nepieciešama lielāka uzmanība. Plānu pielāgosim jūsu vajadzībām un mērķiem.",
    bmi_obese: (b) => "Jūsu ĶMI ir __BMI__, tas tiek uzskatīts par aptaukošanos".replace("__BMI__", String(b)),
    bmi_obese_body: "Jūsu svars var ietekmēt veselību. Izveidosim jums piemērotu plānu.",
    goal_placeholder: "Ievadiet savu mērķa svaru, lai redzētu personalizētus ieteikumus",
    goal_weight_too_high: "Mērķa svaram jābūt mazākam par pašreizējo svaru.",
    goal_too_low: "Jūsu mērķis var būt pārāk zems jūsu ķermenim. Veselīgs ĶMI parasti ir no 18,5 līdz 24,9.",
    goal_a_lot: "Tas ir liels mērķis, un tas ir pilnīgi normāli. Mēs palīdzēsim to sasniegt soli pa solim.",
    goal_moderate: "Tas ir reālistisks mērķis. Vienmērīgs progress var uzlabot veselību.",
    goal_small: "Jūs jau esat tuvu savam mērķim. Arī nelielas pārmaiņas var dot labu rezultātu.",
    consent_text: "Es piekrītu, ka mani veselības dati tiek izmantoti personalizēta plāna izveidei.",
    consent_privacy_link: "Privātuma politika",
    char_count: (n) => "__N__/20".replace("__N__", String(n)),
  },
  ro: {
    error_range: (mn, mx, u) => "Vă rugăm să introduceți o valoare între __MIN__ și __MAX__ __UNIT__".replace("__MIN__", String(mn)).replace("__MAX__", String(mx)).replace("__UNIT__", String(u)),
    bmi_checking: "Calculăm IMC-ul dumneavoastră. Acest lucru ne ajută să creăm planul potrivit pentru corpul dumneavoastră.",
    bmi_underweight: (b) => "IMC-ul dumneavoastră este __BMI__, ceea ce este sub intervalul obișnuit".replace("__BMI__", String(b)),
    bmi_underweight_body: "Ați putea beneficia de exerciții ușoare de tonifiere și de o alimentație echilibrată.",
    bmi_normal: (b) => "IMC-ul dumneavoastră este __BMI__, ceea ce se află într-un interval sănătos".replace("__BMI__", String(b)),
    bmi_normal_body: "Mergeți într-o direcție bună. Continuați cu rutina dumneavoastră.",
    bmi_overweight: (b) => "IMC-ul dumneavoastră este __BMI__, ceea ce este considerat supraponderal".replace("__BMI__", String(b)),
    bmi_overweight_body: "Greutatea dumneavoastră are nevoie de mai multă atenție. Vom adapta planul la nevoile și obiectivele dumneavoastră.",
    bmi_obese: (b) => "IMC-ul dumneavoastră este __BMI__, ceea ce este considerat obezitate".replace("__BMI__", String(b)),
    bmi_obese_body: "Greutatea dumneavoastră vă poate afecta sănătatea. Vom crea un plan potrivit pentru dumneavoastră.",
    goal_placeholder: "Introduceți greutatea dorită pentru a vedea recomandările personalizate",
    goal_weight_too_high: "Greutatea dorită trebuie să fie mai mică decât greutatea actuală.",
    goal_too_low: "Obiectivul dumneavoastră poate fi prea mic pentru corpul dumneavoastră. Un IMC sănătos este, de obicei, între 18,5 și 24,9.",
    goal_a_lot: "Acesta este un obiectiv mare, și este în regulă. Vă vom ajuta să îl atingeți pas cu pas.",
    goal_moderate: "Acesta este un obiectiv realist. Progresul constant vă poate îmbunătăți sănătatea.",
    goal_small: "Sunteți deja aproape de obiectiv. Chiar și schimbările mici pot conta.",
  ...
  cz: {
    error_range: (mn, mx, u) => "Zadejte hodnotu mezi __MIN__ a __MAX__ __UNIT__".replace("__MIN__", String(mn)).replace("__MAX__", String(mx)).replace("__UNIT__", String(u)),
    bmi_checking: "Počítáme vaše BMI. Díky tomu můžeme vytvořit plán vhodný pro vaše tělo.",
    bmi_underweight: (b) => "Vaše BMI je __BMI__, což je pod běžným rozmezím".replace("__BMI__", String(b)),
    bmi_underweight_body: "Může vám prospět jemné posilování a vyvážená strava.",
    bmi_normal: (b) => "Vaše BMI je __BMI__, což je ve zdravém rozmezí".replace("__BMI__", String(b)),
    bmi_normal_body: "Jdete správným směrem. Pokračujte ve své rutině.",
    bmi_overweight: (b) => "Vaše BMI je __BMI__, což se považuje za nadváhu".replace("__BMI__", String(b)),
    bmi_overweight_body: "Vaše váha potřebuje více pozornosti. Přizpůsobíme plán vašim potřebám a cílům.",
    bmi_obese: (b) => "Vaše BMI je __BMI__, což se považuje za obezitu".replace("__BMI__", String(b)),
    bmi_obese_body: "Vaše váha může ovlivňovat zdraví. Vytvoříme plán, který vám bude sedět.",
    goal_placeholder: "Zadejte svou cílovou váhu a zobrazí se osobní doporučení",
    goal_weight_too_high: "Cílová váha musí být nižší než vaše současná váha.",
    goal_too_low: "Váš cíl může být pro vaše tělo příliš nízký. Zdravé BMI se obvykle pohybuje mezi 18,5 a 24,9.",
    goal_a_lot: "To je velký cíl, a to je v pořádku. Pomůžeme vám ho zvládnout krok za krokem.",
    goal_moderate: "Tohle je realistický cíl. Pravidelný pokrok může zlepšit vaše zdraví.",
    goal_small: "Ke svému cíli už máte blízko. I malé změny mohou přinést velký rozdíl.",
    consent_text: "Souhlasím s použitím svých zdravotních údajů k vytvoření osobního plánu.",
    consent_privacy_link: "Zásady ochrany osobních údajů",
    char_count: (n) => "__N__/20".replace("__N__", String(n)),
  },
  dk: {
    error_range: (mn, mx, u) => "Indtast en værdi mellem __MIN__ og __MAX__ __UNIT__".replace("__MIN__", String(mn)).replace("__MAX__", String(mx)).replace("__UNIT__", String(u)),
    bmi_checking: "Vi beregner jeres BMI. Det hjælper os med at skabe den rigtige plan til kroppen.",
    bmi_underweight: (b) => "Jeres BMI er __BMI__, hvilket ligger under det normale interval".replace("__BMI__", String(b)),
    bmi_underweight_body: "Blid styrketræning og en balanceret kost kan være en fordel.",
    bmi_normal: (b) => "Jeres BMI er __BMI__, hvilket ligger i et sundt interval".replace("__BMI__", String(b)),
    bmi_normal_body: "I er på rette vej. Fortsæt med jeres rutine.",
    bmi_overweight: (b) => "Jeres BMI er __BMI__, hvilket betragtes som overvægt".replace("__BMI__", String(b)),
    bmi_overweight_body: "Jeres vægt kræver lidt mere opmærksomhed. Vi tilpasser planen til jeres behov og mål.",
    bmi_obese: (b) => "Jeres BMI er __BMI__, hvilket betragtes som fedme".replace("__BMI__", String(b)),
    bmi_obese_body: "Jeres vægt kan påvirke helbredet. Vi bygger en plan, der passer til jeres behov.",
    goal_placeholder: "Indtast jeres målvægt for at se personlig vejledning",
    goal_weight_too_high: "Målvægten skal være lavere end den nuværende vægt.",
    goal_too_low: "Målet kan være for lavt for kroppen. Et sundt BMI ligger normalt mellem 18,5 og 24,9.",
    goal_a_lot: "Det er et stort mål, og det er helt okay. Vi hjælper jer trin for trin.",
    goal_moderate: "Det er et realistisk mål. Stabil fremgang kan forbedre helbredet.",
    goal_small: "I er allerede tæt på målet. Små ændringer kan stadig gøre en tydelig forskel.",
    consent_text: "Jeg giver samtykke til, at mine sundhedsdata bruges til at lave en personlig plan.",
    consent_privacy_link: "Privatlivspolitik",
    char_count: (n) => "__N__/20".replace("__N__", String(n)),
  },
  gr: {
    error_range: (mn, mx, u) => "Παρακαλώ εισάγετε τιμή από __MIN__ έως __MAX__ __UNIT__".replace("__MIN__", String(mn)).replace("__MAX__", String(mx)).replace("__UNIT__", String(u)),
    bmi_checking: "Υπολογίζουμε τον ΔΜΣ σας. Αυτό μας βοηθά να δημιουργήσουμε το σωστό πλάνο για το σώμα σας.",
    bmi_underweight: (b) => "Ο ΔΜΣ σας είναι __BMI__, κάτι που βρίσκεται κάτω από το συνηθισμένο εύρος".replace("__BMI__", String(b)),
    bmi_underweight_body: "Ίσως σας βοηθήσουν ήπιες ασκήσεις ενδυνάμωσης και ισορροπημένη διατροφή.",
    bmi_normal: (b) => "Ο ΔΜΣ σας είναι __BMI__, κάτι που βρίσκεται σε υγιές εύρος".replace("__BMI__", String(b)),
    bmi_normal_body: "Κινείστε προς τη σωστή κατεύθυνση. Συνεχίστε τη ρουτίνα σας.",
    bmi_overweight: (b) => "Ο ΔΜΣ σας είναι __BMI__, κάτι που θεωρείται υπέρβαρο".replace("__BMI__", String(b)),
    bmi_overweight_body: "Το βάρος σας χρειάζεται περισσότερη προσοχή. Θα προσαρμόσουμε το πλάνο στις ανάγκες και τους στόχους σας.",
    bmi_obese: (b) => "Ο ΔΜΣ σας είναι __BMI__, κάτι που θεωρείται παχυσαρκία".replace("__BMI__", String(b)),
    bmi_obese_body: "Το βάρος σας μπορεί να επηρεάζει την υγεία σας. Θα δημιουργήσουμε ένα πλάνο που σας ταιριάζει.",
    goal_placeholder: "Εισάγετε το βάρος στόχο σας για να δείτε εξατομικευμένη καθοδήγηση",
    goal_weight_too_high: "Το βάρος στόχος πρέπει να είναι χαμηλότερο από το τωρινό σας βάρος.",
    goal_too_low: "Ο στόχος σας ίσως είναι πολύ χαμηλός για το σώμα σας. Ένας υγιής ΔΜΣ συνήθως κυμαίνεται από 18,5 έως 24,9.",
    goal_a_lot: "Αυτός είναι ένας μεγάλος στόχος, και είναι απολύτως εντάξει. Θα σας βοηθήσουμε βήμα βήμα.",
    goal_moderate: "Αυτός είναι ένας ρεαλιστικός στόχος. Η σταθερή πρόοδος μπορεί να βελτιώσει την υγεία σας.",
    goal_small: "Είστε ήδη κοντά στον στόχο σας. Ακόμα και μικρές αλλαγές μπορούν να κάνουν διαφορά.",
    consent_text: "Επιτρέπω τη χρήση των δεδομένων υγείας μου για τη δημιουργία εξατομικευμένου πλάνου.",
    consent_privacy_link: "Πολιτική απορρήτου",
    char_count: (n) => "__N__/20".replace("__N__", String(n)),
  },
  hu: {
    error_range: (mn, mx, u) => "Adjon meg egy értéket __MIN__ és __MAX__ __UNIT__ között".replace("__MIN__", String(mn)).replace("__MAX__", String(mx)).replace("__UNIT__", String(u)),
    bmi_checking: "Számoljuk a BMI-jét. Ez segít a testének megfelelő terv kialakításában.",
    bmi_underweight: (b) => "Az Ön BMI-je __BMI__, ami az átlagos tartomány alatt van".replace("__BMI__", String(b)),
    bmi_underweight_body: "A kíméletes erősítő mozgás és a kiegyensúlyozott táplálkozás hasznos lehet.",
    bmi_normal: (b) => "Az Ön BMI-je __BMI__, ami egészséges tartományban van".replace("__BMI__", String(b)),
    bmi_normal_body: "Jó irányba halad. Érdemes folytatni a kialakított rutint.",
    bmi_overweight: (b) => "Az Ön BMI-je __BMI__, ami túlsúlynak számít".replace("__BMI__", String(b)),
    bmi_overweight_body: "A testsúlya több figyelmet igényel. A tervet az igényeihez és céljaihoz igazítjuk.",
    bmi_obese: (b) => "Az Ön BMI-je __BMI__, ami elhízásnak számít".replace("__BMI__", String(b)),
    bmi_obese_body: "A testsúlya hatással lehet az egészségére. Olyan tervet készítünk, amely jól illik Önhöz.",
    goal_placeholder: "Adja meg a céltestsúlyát a személyre szabott útmutatáshoz",
    goal_weight_too_high: "A céltestsúlynak alacsonyabbnak kell lennie a jelenlegi testsúlynál.",
    goal_too_low: "Lehet, hogy ez a cél túl alacsony a testének. Az egészséges BMI általában 18,5 és 24,9 között van.",
    goal_a_lot: "Ez nagy cél, és ez teljesen rendben van. Lépésről lépésre segítünk elérni.",
    goal_moderate: "Ez reális cél. Az egyenletes haladás sokat javíthat az egészségen.",
    goal_small: "Már most is közel van a céljához. A kisebb változtatások is sokat számíthatnak.",
    consent_text: "Hozzájárulok, hogy egészségügyi adataimat személyre szabott terv készítéséhez használják fel.",
    consent_privacy_link: "Adatvédelmi szabályzat",
    char_count: (n) => "__N__/20".replace("__N__", String(n)),
  },
  hr: {
    error_range: (mn, mx, u) => "Unesite vrijednost između __MIN__ i __MAX__ __UNIT__".replace("__MIN__", String(mn)).replace("__MAX__", String(mx)).replace("__UNIT__", String(u)),
    bmi_checking: "Izračunavamo vaš BMI. To nam pomaže da izradimo plan koji odgovara vašem tijelu.",
    bmi_underweight: (b) => "Vaš BMI je __BMI__, što je ispod uobičajenog raspona".replace("__BMI__", String(b)),
    bmi_underweight_body: "Mogli bi vam koristiti blagi treninzi snage i uravnotežena prehrana.",
    bmi_normal: (b) => "Vaš BMI je __BMI__, što je u zdravom rasponu".replace("__BMI__", String(b)),
    bmi_normal_body: "Idete u dobrom smjeru. Nastavite sa svojom rutinom.",
    bmi_overweight: (b) => "Vaš BMI je __BMI__, što se smatra prekomjernom težinom".replace("__BMI__", String(b)),
    bmi_overweight_body: "Vaša težina traži više pažnje. Plan ćemo prilagoditi vašim potrebama i ciljevima.",
    bmi_obese: (b) => "Vaš BMI je __BMI__, što se smatra pretilošću".replace("__BMI__", String(b)),
    bmi_obese_body: "Vaša težina može utjecati na zdravlje. Izradit ćemo plan koji vam odgovara.",
    goal_placeholder: "Unesite ciljanu težinu kako biste vidjeli personalizirane smjernice",
    goal_weight_too_high: "Ciljana težina mora biti manja od vaše trenutačne težine.",
    goal_too_low: "Vaš cilj možda je prenizak za vaše tijelo. Zdrav BMI obično je između 18,5 i 24,9.",
    goal_a_lot: "To je velik cilj, i to je sasvim u redu. Pomoći ćemo vam da ga ostvarite korak po korak.",
    goal_moderate: "To je realan cilj. Stalan napredak može poboljšati vaše zdravlje.",
    goal_small: "Već ste blizu svog cilja. I male promjene mogu napraviti veliku razliku.",
    consent_text: "Dajem dopuštenje za korištenje mojih zdravstvenih podataka radi izrade personaliziranog plana.",
    consent_privacy_link: "Pravila privatnosti",
    char_count: (n) => "__N__/20".replace("__N__", String(n)),
  },
  il: {
    error_range: (mn, mx, u) => "נא להזין ערך בין __MIN__ ל-__MAX__ __UNIT__".replace("__MIN__", String(mn)).replace("__MAX__", String(mx)).replace("__UNIT__", String(u)),
    bmi_checking: "אנחנו מחשבים את ה-BMI שלכם. זה עוזר לנו לבנות תוכנית שמתאימה לגוף שלכם.",
    bmi_underweight: (b) => "ה-BMI שלכם הוא __BMI__, והוא נמוך מהטווח המקובל".replace("__BMI__", String(b)),
    bmi_underweight_body: "ייתכן שפעילות חיזוק עדינה ותזונה מאוזנת יועילו לכם.",
    bmi_normal: (b) => "ה-BMI שלכם הוא __BMI__, והוא בטווח בריא".replace("__BMI__", String(b)),
    bmi_normal_body: "אתם בכיוון הנכון. המשיכו בשגרה שלכם.",
    bmi_overweight: (b) => "ה-BMI שלכם הוא __BMI__, והוא נחשב לעודף משקל".replace("__BMI__", String(b)),
    bmi_overweight_body: "המשקל שלכם דורש יותר תשומת לב. נתאים את התוכנית לצרכים ולמטרות שלכם.",
    bmi_obese: (b) => "ה-BMI שלכם הוא __BMI__, והוא נחשב להשמנה".replace("__BMI__", String(b)),
    bmi_obese_body: "המשקל שלכם עלול להשפיע על הבריאות. נבנה תוכנית שמתאימה לכם.",
    goal_placeholder: "הזינו את משקל היעד כדי לראות הכוונה אישית",
    goal_weight_too_high: "משקל היעד חייב להיות נמוך מהמשקל הנוכחי.",
    goal_too_low: "ייתכן שהיעד נמוך מדי עבור הגוף שלכם. BMI בריא נמצא בדרך כלל בין 18.5 ל-24.9.",
    goal_a_lot: "זה יעד גדול, וזה לגמרי בסדר. נעזור לכם להגיע אליו צעד אחר צעד.",
    goal_moderate: "זה יעד מציאותי. התקדמות עקבית יכולה לשפר את הבריאות שלכם.",
    goal_small: "אתם כבר קרובים ליעד. גם שינויים קטנים יכולים לעשות הבדל גדול.",
    consent_text: "אני מאשר שימוש בנתוני הבריאות שלי לצורך יצירת תוכנית אישית.",
    consent_privacy_link: "מדיניות הפרטיות",
    char_count: (n) => "__N__/20".replace("__N__", String(n)),
  },
  jp: {
    error_range: (mn, mx, u) => "__MIN__〜__MAX__ __UNIT__ の範囲で入力してください".replace("__MIN__", String(mn)).replace("__MAX__", String(mx)).replace("__UNIT__", String(u)),
    bmi_checking: "BMIを計算しています。体に合ったプランを作るために役立ちます。",
    bmi_underweight: (b) => "あなたのBMIは __BMI__ で、一般的な範囲より低めです".replace("__BMI__", String(b)),
    bmi_underweight_body: "やさしい筋力づくりとバランスのよい食事が役立つ可能性があります。",
    bmi_normal: (b) => "あなたのBMIは __BMI__ で、健康的な範囲にあります".replace("__BMI__", String(b)),
    bmi_normal_body: "よい方向に進んでいます。この調子で続けましょう。",
    bmi_overweight: (b) => "あなたのBMIは __BMI__ で、過体重にあたります".replace("__BMI__", String(b)),
    bmi_overweight_body: "体重には少し丁寧なケアが必要です。あなたの体と目標に合わせてプランを調整します。",
    bmi_obese: (b) => "あなたのBMIは __BMI__ で、肥満にあたります".replace("__BMI__", String(b)),
    bmi_obese_body: "体重が健康に影響する可能性があります。あなたに合った計画を作成します。",
    goal_placeholder: "目標体重を入力すると、あなた向けのガイダンスが表示されます",
    goal_weight_too_high: "目標体重は現在の体重より低く設定してください。",
    goal_too_low: "その目標は体に対して低すぎる可能性があります。健康的なBMIは通常18.5〜24.9です。",
    goal_a_lot: "大きな目標でも大丈夫です。一歩ずつ達成できるようにサポートします。",
    goal_moderate: "現実的な目標です。着実な前進が健康改善につながります。",
    goal_small: "目標までもう少しです。小さな変化でも十分に意味があります。",
    consent_text: "個別プラン作成のために、健康データを利用することに同意します。",
    consent_privacy_link: "プライバシーポリシー",
    char_count: (n) => "__N__/20".replace("__N__", String(n)),
  },
  ru: {
    error_range: (mn, mx, u) => "Введите значение от __MIN__ до __MAX__ __UNIT__".replace("__MIN__", String(mn)).replace("__MAX__", String(mx)).replace("__UNIT__", String(u)),
    bmi_checking: "Рассчитываем ваш ИМТ. Это помогает нам подобрать план, который подходит вашему телу.",
    bmi_underweight: (b) => "Ваш ИМТ — __BMI__, это ниже обычного диапазона".replace("__BMI__", String(b)),
    bmi_underweight_body: "Вам могут подойти мягкие силовые упражнения и сбалансированное питание.",
    bmi_normal: (b) => "Ваш ИМТ — __BMI__, это здоровый диапазон".replace("__BMI__", String(b)),
    bmi_normal_body: "Вы движетесь в правильном направлении. Продолжайте в том же темпе.",
    bmi_overweight: (b) => "Ваш ИМТ — __BMI__, это считается избыточным весом".replace("__BMI__", String(b)),
    bmi_overweight_body: "Вашему весу нужно больше внимания. Мы адаптируем план под ваши цели и потребности.",
    bmi_obese: (b) => "Ваш ИМТ — __BMI__, это считается ожирением".replace("__BMI__", String(b)),
    bmi_obese_body: "Ваш вес может влиять на здоровье. Мы создадим план, который подойдёт именно вам.",
    goal_placeholder: "Введите целевой вес, чтобы увидеть персональные рекомендации",
    goal_weight_too_high: "Целевой вес должен быть ниже текущего.",
    goal_too_low: "Ваша цель может быть слишком низкой для вашего тела. Здоровый ИМТ обычно находится в диапазоне от 18,5 до 24,9.",
    goal_a_lot: "Это большая цель, и это нормально. Мы поможем вам дойти до неё шаг за шагом.",
    goal_moderate: "Это реалистичная цель. Последовательный прогресс может улучшить ваше здоровье.",
    goal_small: "Вы уже близко к своей цели. Даже небольшие изменения могут дать заметный результат.",
    consent_text: "Я разрешаю использовать мои данные о здоровье для создания персонального плана.",
    consent_privacy_link: "Политика конфиденциальности",
    char_count: (n) => "__N__/20".replace("__N__", String(n)),
  },
  sk: {
    error_range: (mn, mx, u) => "Zadajte hodnotu od __MIN__ do __MAX__ __UNIT__".replace("__MIN__", String(mn)).replace("__MAX__", String(mx)).replace("__UNIT__", String(u)),
    bmi_checking: "Počítame vaše BMI. Pomáha nám to vytvoriť plán vhodný pre vaše telo.",
    bmi_underweight: (b) => "Vaše BMI je __BMI__, čo je pod bežným rozmedzím".replace("__BMI__", String(b)),
    bmi_underweight_body: "Môže vám prospieť jemné posilňovanie a vyvážená strava.",
    bmi_normal: (b) => "Vaše BMI je __BMI__, čo je v zdravom rozmedzí".replace("__BMI__", String(b)),
    bmi_normal_body: "Idete správnym smerom. Pokračujte vo svojej rutine.",
    bmi_overweight: (b) => "Vaše BMI je __BMI__, čo sa považuje za nadváhu".replace("__BMI__", String(b)),
    bmi_overweight_body: "Vaša hmotnosť si vyžaduje viac pozornosti. Plán prispôsobíme vašim potrebám a cieľom.",
    bmi_obese: (b) => "Vaše BMI je __BMI__, čo sa považuje za obezitu".replace("__BMI__", String(b)),
    bmi_obese_body: "Vaša hmotnosť môže ovplyvňovať zdravie. Vytvoríme plán, ktorý vám sadne.",
    goal_placeholder: "Zadajte svoju cieľovú hmotnosť a zobrazí sa osobné odporúčanie",
    goal_weight_too_high: "Cieľová hmotnosť musí byť nižšia ako vaša aktuálna hmotnosť.",
    goal_too_low: "Váš cieľ môže byť pre vaše telo príliš nízky. Zdravé BMI sa zvyčajne pohybuje medzi 18,5 a 24,9.",
    goal_a_lot: "To je veľký cieľ, a to je v poriadku. Pomôžeme vám ho dosiahnuť krok za krokom.",
    goal_moderate: "To je realistický cieľ. Stabilný pokrok môže zlepšiť vaše zdravie.",
    goal_small: "K svojmu cieľu už máte blízko. Aj malé zmeny môžu priniesť rozdiel.",
    consent_text: "Súhlasím s použitím svojich zdravotných údajov na vytvorenie personalizovaného plánu.",
    consent_privacy_link: "Zásady ochrany súkromia",
    char_count: (n) => "__N__/20".replace("__N__", String(n)),
  },
  tw: {
    error_range: (mn, mx, u) => "請輸入介於 __MIN__ 到 __MAX__ __UNIT__ 之間的數值".replace("__MIN__", String(mn)).replace("__MAX__", String(mx)).replace("__UNIT__", String(u)),
    bmi_checking: "正在計算您的 BMI，這能幫助我們建立更適合您身體狀況的計畫。",
    bmi_underweight: (b) => "您的 BMI 為 __BMI__，低於一般常見範圍".replace("__BMI__", String(b)),
    bmi_underweight_body: "溫和的肌力訓練與均衡飲食可能會對您有幫助。",
    bmi_normal: (b) => "您的 BMI 為 __BMI__，落在健康範圍內".replace("__BMI__", String(b)),
    bmi_normal_body: "您正朝著正確方向前進，請持續保持。",
    bmi_overweight: (b) => "您的 BMI 為 __BMI__，屬於過重範圍".replace("__BMI__", String(b)),
    bmi_overweight_body: "您的體重需要更多關注。我們會依照您的需求與目標調整計畫。",
    bmi_obese: (b) => "您的 BMI 為 __BMI__，屬於肥胖範圍".replace("__BMI__", String(b)),
    bmi_obese_body: "您的體重可能會影響健康。我們會為您建立合適的計畫。",
    goal_placeholder: "輸入目標體重，即可查看個人化建議",
    goal_weight_too_high: "目標體重必須低於目前體重。",
    goal_too_low: "這個目標對您的身體來說可能過低。健康 BMI 通常介於 18.5 到 24.9 之間。",
    goal_a_lot: "這是一個很大的目標，但完全沒有問題，我們會一步一步陪您達成。",
    goal_moderate: "這是一個很實際的目標，穩定進步有助於改善健康。",
    goal_small: "您已經很接近目標了，即使是小小的改變也能帶來明顯差異。",
    consent_text: "我同意使用我的健康資料來建立個人化計畫。",
...
const result: Record<LangCode, ResultTranslations> = {
  en: {
    header_label: "Your Plan",
    headline: "Your personal plan is ready",
    subtitle: "You are moving in the right direction.",
    guide_text: "We will guide you step by step so you can stay consistent and see progress.",
    goal_line: (w, d, u) => "__W__ __U__ by __D__".replace("__W__", String(w)).replace("__D__", String(d)).replace("__U__", String(u)),
    cta: "Get My Plan",
  },
  lt: {
    header_label: "Jūsų planas",
    headline: "Jūsų asmeninis planas paruoštas",
    subtitle: "Judate teisinga kryptimi.",
    guide_text: "Vesime jus žingsnis po žingsnio, kad galėtumėte išlikti nuoseklūs ir matyti pažangą.",
    goal_line: (w, d, u) => "__W__ __U__ iki __D__".replace("__W__", String(w)).replace("__D__", String(d)).replace("__U__", String(u)),
    cta: "Gauti mano planą",
  },
  lv: {
    header_label: "Jūsu plāns",
    headline: "Jūsu personīgais plāns ir gatavs",
    subtitle: "Jūs virzāties pareizajā virzienā.",
    guide_text: "Mēs vadīsim jūs soli pa solim, lai jūs varētu saglabāt regularitāti un redzēt progresu.",
    goal_line: (w, d, u) => "__W__ __U__ līdz __D__".replace("__W__", String(w)).replace("__D__", String(d)).replace("__U__", String(u)),
    cta: "Saņemt manu plānu",
  },
  ro: {
    header_label: "Planul dumneavoastră",
    headline: "Planul personal este gata",
    subtitle: "Mergeți în direcția potrivită.",
    guide_text: "Vă vom ghida pas cu pas, ca să rămâneți consecvenți și să vedeți progresul.",
    goal_line: (w, d, u) => "__W__ __U__ până la __D__".replace("__W__", String(w)).replace("__D__", String(d)).replace("__U__", String(u)),
    cta: "Vreau planul meu",
  },
  cz: {
    header_label: "Váš plán",
    headline: "Váš osobní plán je připraven",
    subtitle: "Jdete správným směrem.",
    guide_text: "Povedeme vás krok za krokem, abyste vydrželi a viděli pokrok.",
    goal_line: (w, d, u) => "__W__ __U__ do __D__".replace("__W__", String(w)).replace("__D__", String(d)).replace("__U__", String(u)),
    cta: "Získat můj plán",
  },
  dk: {
    header_label: "Jeres plan",
    headline: "Jeres personlige plan er klar",
    subtitle: "I bevæger jer i den rigtige retning.",
    guide_text: "Vi guider jer trin for trin, så I kan holde fast og se fremgang.",
    goal_line: (w, d, u) => "__W__ __U__ inden __D__".replace("__W__", String(w)).replace("__D__", String(d)).replace("__U__", String(u)),
    cta: "Få min plan",
  },
  gr: {
    header_label: "Το πλάνο σας",
    headline: "Το προσωπικό σας πλάνο είναι έτοιμο",
    subtitle: "Κινείστε προς τη σωστή κατεύθυνση.",
    guide_text: "Θα σας καθοδηγήσουμε βήμα βήμα, ώστε να παραμείνετε σταθεροί και να βλέπετε πρόοδο.",
    goal_line: (w, d, u) => "__W__ __U__ έως __D__".replace("__W__", String(w)).replace("__D__", String(d)).replace("__U__", String(u)),
    cta: "Αποκτήστε το πλάνο μου",
  },
  hu: {
    header_label: "Az Ön terve",
    headline: "Elkészült a személyre szabott terve",
    subtitle: "Jó irányba halad.",
    guide_text: "Lépésről lépésre segítünk, hogy kitartson és lássa a fejlődést.",
    goal_line: (w, d, u) => "__W__ __U__ __D__ időpontra".replace("__W__", String(w)).replace("__D__", String(d)).replace("__U__", String(u)),
    cta: "Kérem a tervemet",
  },
  hr: {
    header_label: "Vaš plan",
    headline: "Vaš osobni plan je spreman",
    subtitle: "Krećete se u pravom smjeru.",
    guide_text: "Vodit ćemo vas korak po korak kako biste ostali dosljedni i vidjeli napredak.",
    goal_line: (w, d, u) => "__W__ __U__ do __D__".replace("__W__", String(w)).replace("__D__", String(d)).replace("__U__", String(u)),
    cta: "Preuzmi moj plan",
  },
  il: {
    header_label: "התוכנית שלכם",
    headline: "התוכנית האישית שלכם מוכנה",
    subtitle: "אתם נעים בכיוון הנכון.",
    guide_text: "נלווה אתכם צעד אחר צעד כדי שתוכלו להתמיד ולראות התקדמות.",
    goal_line: (w, d, u) => "__W__ __U__ עד __D__".replace("__W__", String(w)).replace("__D__", String(d)).replace("__U__", String(u)),
    cta: "קבלו את התוכנית שלי",
  },
  jp: {
    header_label: "あなたのプラン",
    headline: "あなた専用のプランが完成しました",
    subtitle: "順調に前へ進んでいます。",
    guide_text: "続けやすく、変化を実感できるように、私たちが一歩ずつご案内します。",
    goal_line: (w, d, u) => "__D__ までに __W__ __U__".replace("__W__", String(w)).replace("__D__", String(d)).replace("__U__", String(u)),
    cta: "プランを見る",
  },
  ru: {
    header_label: "Ваш план",
    headline: "Ваш персональный план готов",
    subtitle: "Вы движетесь в правильном направлении.",
    guide_text: "Мы будем вести вас шаг за шагом, чтобы вам было легче сохранять регулярность и видеть результат.",
    goal_line: (w, d, u) => "__W__ __U__ к __D__".replace("__W__", String(w)).replace("__D__", String(d)).replace("__U__", String(u)),
    cta: "Получить мой план",
  },
  sk: {
    header_label: "Váš plán",
    headline: "Váš osobný plán je pripravený",
    subtitle: "Idete správnym smerom.",
    guide_text: "Budeme vás viesť krok za krokom, aby ste vydržali a videli pokrok.",
    goal_line: (w, d, u) => "__W__ __U__ do __D__".replace("__W__", String(w)).replace("__D__", String(d)).replace("__U__", String(u)),
    cta: "Získať môj plán",
  },
  tw: {
    header_label: "您的計畫",
    headline: "您的個人化計畫已準備完成",
    subtitle: "您正朝著正確方向前進。",
    guide_text: "我們會一步一步引導您，幫助您持續下去並看見進展。",
    goal_line: (w, d, u) => "__D__ 前達到 __W__ __U__".replace("__W__", String(w)).replace("__D__", String(d)).replace("__U__", String(u)),
    cta: "查看我的計畫",
  }
}
...
const results28: Record<LangCode, Results28Translations> = {
  en: {
    ...
    chart_note: "This chart is for illustrative purposes only",
    headline: "Get visible results in only 28 days!",
  },
  lt: {
    header_label: "Jūsų planas",
    ...
    chart_note: "Ši diagrama skirta tik iliustracijai",
    headline: "Pamatykite matomus rezultatus vos per 28 dienas!",
  },
  lv: {
    header_label: "Jūsu plāns",
    ...
    chart_note: "Šī diagramma ir tikai ilustratīva",
    headline: "Redzami rezultāti jau 28 dienās!",
  },
  ro: {
    header_label: "Planul dumneavoastră",
    your_weight: "Greutatea dumneavoastră",
    now: "Acum",
    after_4_weeks: "După 4 săptămâni",
    week: (n) => "Săptămâna __N__".replace("__N__", String(n)),
    chart_note: "Acest grafic are doar rol ilustrativ",
    headline: "Obțineți rezultate vizibile în doar 28 de zile!",
  },
  cz: {
    header_label: "Váš plán",
    your_weight: "Vaše váha",
    now: "Teď",
    after_4_weeks: "Za 4 týdny",
    week: (n) => "__N__. týden".replace("__N__", String(n)),
    chart_note: "Tento graf je pouze ilustrativní",
    headline: "Viditelné výsledky už za 28 dní!",
  },
  dk: {
    header_label: "Jeres plan",
    your_weight: "Jeres vægt",
    now: "Nu",
    after_4_weeks: "Efter 4 uger",
    week: (n) => "Uge __N__".replace("__N__", String(n)),
    chart_note: "Denne graf er kun vejledende",
    headline: "Få synlige resultater på kun 28 dage!",
  },
  gr: {
    header_label: "Το πλάνο σας",
    ...
    chart_note: "Αυτό το γράφημα είναι μόνο ενδεικτικό",
    headline: "Δείτε ορατά αποτελέσματα σε μόλις 28 ημέρες!",
  },
  hu: {
    header_label: "Az Ön terve",
    your_weight: "Az Ön súlya",
    now: "Most",
    after_4_weeks: "4 hét múlva",
    week: (n) => "__N__. hét".replace("__N__", String(n)),
    chart_note: "Ez a grafikon csak szemléltető jellegű",
    headline: "Látható eredmények már 28 nap alatt!",
  },
  hr: {
    header_label: "Vaš plan",
    your_weight: "Vaša težina",
    now: "Sada",
    after_4_weeks: "Nakon 4 tjedna",
    week: (n) => "__N__. tjedan".replace("__N__", String(n)),
    chart_note: "Ovaj graf služi samo kao ilustracija",
    headline: "Vidljivi rezultati u samo 28 dana!",
  },
  il: {
    header_label: "התוכנית שלכם",
    your_weight: "המשקל שלכם",
    now: "עכשיו",
    after_4_weeks: "אחרי 4 שבועות",
    week: (n) => "שבוע __N__".replace("__N__", String(n)),
    chart_note: "התרשים הזה מיועד להמחשה בלבד",
    headline: "תוצאות נראות לעין כבר בתוך 28 ימים!",
  },
  jp: {
    header_label: "あなたのプラン",
    your_weight: "現在の体重",
    now: "今",
    after_4_weeks: "4週間後",
    week: (n) => "__N__週目".replace("__N__", String(n)),
    chart_note: "このグラフはイメージです",
    headline: "たった28日で目に見える変化を目指しましょう！",
  },
  ru: {
    header_label: "Ваш план",
    your_weight: "Ваш вес",
    ...
    week: (n) => "__N__-я неделя".replace("__N__", String(n)),
    chart_note: "Этот график приведён только для наглядности",
    headline: "Заметные результаты всего за 28 дней!",
  },
  sk: {
    header_label: "Váš plán",
    your_weight: "Vaša hmotnosť",
    now: "Teraz",
    after_4_weeks: "Po 4 týždňoch",
    week: (n) => "__N__. týždeň".replace("__N__", String(n)),
    chart_note: "Tento graf má len ilustračný charakter",
    headline: "Viditeľné výsledky už za 28 dní!",
  },
  tw: {
    header_label: "您的計畫",
    your_weight: "您的體重",
    ...
    chart_note: "此圖表僅供示意參考",
    headline: "只要 28 天，就能看見明顯變化！",
  }
}

const wellness: Record<LangCode, WellnessTranslations> = {
  en: {
    header_label: "Wellness Profile",
    headline: "Here is your personal profile",
    lifestyle_label: "Lifestyle",
    eater_label: "Type of Eater",
    motivation_label: "Fitness Motivation",
    img_alt: "Person in athletic wear",
    warning_title: "Risks for an unhealthy BMI",
    warning_desc: "Your weight is risky for your health.",
    bmi_normal_msg: "Your BMI is in a healthy range. Keep maintaining your good habits.",
    bmi_overweight_msg: "Your BMI is above the usual range. Our plan will help you improve step by step.",
    bmi_obese_msg: "Your BMI is higher than recommended. We will guide you with a safe, personalized plan.",
    lifestyle: { "on-feet":"Active", active:"Moderately active", sitting:"Mostly sedentary", advanced:"Very active", intermediate:"Moderately active", beginner:"Light" },
    eater: { balanced:"Balanced", sweet:"Sweet tooth", salty:"Salty snacker", emotional:"Emotional eater" },
    motivation: { high:"High", moderate:"Moderate", low:"Low" },
  },
  lt: {
    header_label: "Savijautos profilis",
    headline: "Štai jūsų asmeninis profilis",
    lifestyle_label: "Gyvenimo būdas",
    eater_label: "Mitybos tipas",
    motivation_label: "Motyvacija",
    img_alt: "Žmogus su sportine apranga",
    warning_title: "Nesveiko KMI rizikos",
    warning_desc: "Jūsų svoris gali kelti riziką sveikatai.",
    bmi_normal_msg: "Jūsų KMI yra sveikame diapazone. Išlaikykite gerus įpročius.",
    bmi_overweight_msg: "Jūsų KMI viršija įprastą ribą. Mūsų planas padės judėti pirmyn žingsnis po žingsnio.",
    bmi_obese_msg: "Jūsų KMI yra aukštesnis nei rekomenduojama. Jus lydėsime saugiu, asmenišku planu.",
    lifestyle: { "on-feet":"Aktyvus", active:"Vidutiniškai aktyvus", sitting:"Daugiausia sėdimas", advanced:"Labai aktyvus", intermediate:"Vidutiniškai aktyvus", beginner:"Lengvas" },
    eater: { balanced:"Subalansuotas", sweet:"Mėgstantis saldumynus", salty:"Mėgstantis sūrų maistą", emotional:"Valgantis dėl emocijų" },
    motivation: { high:"Aukšta", moderate:"Vidutinė", low:"Žema" },
  },
  lv: {
    header_label: "Labsajūtas profils",
    headline: "Lūk, jūsu personīgais profils",
    lifestyle_label: "Dzīvesveids",
    eater_label: "Ēšanas tips",
    motivation_label: "Motivācija",
    img_alt: "Persona sporta apģērbā",
    warning_title: "Neveselīga ĶMI riski",
    warning_desc: "Jūsu svars var radīt risku veselībai.",
    bmi_normal_msg: "Jūsu ĶMI ir veselīgā diapazonā. Saglabājiet savus labos ieradumus.",
    bmi_overweight_msg: "Jūsu ĶMI ir virs ierastā diapazona. Mūsu plāns palīdzēs uzlaboties soli pa solim.",
    bmi_obese_msg: "Jūsu ĶMI ir augstāks nekā ieteikts. Mēs jūs vadīsim ar drošu, personalizētu plānu.",
    lifestyle: { "on-feet":"Aktīvs", active:"Vidēji aktīvs", sitting:"Pārsvarā sēdošs", advanced:"Ļoti aktīvs", intermediate:"Vidēji aktīvs", beginner:"Viegls" },
    eater: { balanced:"Sabalansēts", sweet:"Saldummīlis", salty:"Sāļo uzkodu cienītājs", emotional:"Emocionāls ēdājs" },
    motivation: { high:"Augsta", moderate:"Vidēja", low:"Zema" },
  },
  ro: {
    header_label: "Profil de bunăstare",
    headline: "Iată profilul dumneavoastră personal",
    lifestyle_label: "Stil de viață",
    eater_label: "Tip de alimentație",
    motivation_label: "Motivație",
    img_alt: "Persoană în echipament sportiv",
    warning_title: "Riscurile unui IMC nesănătos",
    warning_desc: "Greutatea dumneavoastră poate reprezenta un risc pentru sănătate.",
    bmi_normal_msg: "IMC-ul dumneavoastră este într-un interval sănătos. Păstrați-vă obiceiurile bune.",
    bmi_overweight_msg: "IMC-ul dumneavoastră este peste intervalul obișnuit. Planul nostru vă va ajuta pas cu pas.",
    bmi_obese_msg: "IMC-ul dumneavoastră este mai mare decât recomandat. Vă vom ghida cu un plan sigur și personalizat.",
    lifestyle: { "on-feet":"Activ", active:"Moderat activ", sitting:"Mai mult sedentar", advanced:"Foarte activ", intermediate:"Moderat activ", beginner:"Ușor" },
    eater: { balanced:"Echilibrat", sweet:"Pofticios de dulce", salty:"Amator de gustări sărate", emotional:"Mănânc emoțional" },
    motivation: { high:"Ridicată", moderate:"Moderată", low:"Scăzută" },
  },
  cz: {
    header_label: "Profil pohody",
    headline: "Toto je váš osobní profil",
    lifestyle_label: "Životní styl",
    eater_label: "Stravovací typ",
    motivation_label: "Motivace",
    img_alt: "Osoba ve sportovním oblečení",
    warning_title: "Rizika nezdravého BMI",
    warning_desc: "Vaše váha může představovat zdravotní riziko.",
    bmi_normal_msg: "Vaše BMI je ve zdravém rozmezí. Udržujte si dobré návyky.",
    bmi_overweight_msg: "Vaše BMI je nad běžným rozmezím. Náš plán vám pomůže zlepšovat se krok za krokem.",
    bmi_obese_msg: "Vaše BMI je vyšší, než se doporučuje. Provedeme vás bezpečným a osobním plánem.",
    lifestyle: { "on-feet":"Aktivní", active:"Středně aktivní", sitting:"Převážně sedavý", advanced:"Velmi aktivní", intermediate:"Středně aktivní", beginner:"Lehký" },
    eater: { balanced:"Vyvážený", sweet:"Milovník sladkého", salty:"Milovník slaného", emotional:"Jím podle emocí" },
    motivation: { high:"Vysoká", moderate:"Střední", low:"Nízká" },
  },
  dk: {
    header_label: "Trivselsprofil",
    headline: "Her er jeres personlige profil",
    lifestyle_label: "Livsstil",
    eater_label: "Spisevaner",
    motivation_label: "Motivation",
    img_alt: "Person i sportstøj",
    warning_title: "Risici ved et usundt BMI",
    warning_desc: "Jeres vægt kan udgøre en risiko for helbredet.",
    bmi_normal_msg: "Jeres BMI ligger i et sundt interval. Bevar de gode vaner.",
    bmi_overweight_msg: "Jeres BMI ligger over det normale interval. Vores plan hjælper jer frem trin for trin.",
    bmi_obese_msg: "Jeres BMI er højere end anbefalet. Vi guider jer med en sikker, personlig plan.",
    lifestyle: { "on-feet":"Aktiv", active:"Moderat aktiv", sitting:"Mest stillesiddende", advanced:"Meget aktiv", intermediate:"Moderat aktiv", beginner:"Let" },
    eater: { balanced:"Balanceret", sweet:"Slikmund", salty:"Elsker salte snacks", emotional:"Følelsesstyret spiser" },
    motivation: { high:"Høj", moderate:"Mellem", low:"Lav" },
  },
  gr: {
    header_label: "Προφίλ ευεξίας",
    headline: "Αυτό είναι το προσωπικό σας προφίλ",
    lifestyle_label: "Τρόπος ζωής",
    eater_label: "Τύπος διατροφής",
    motivation_label: "Κίνητρο",
    img_alt: "Άτομο με αθλητικά ρούχα",
    warning_title: "Κίνδυνοι από μη υγιή ΔΜΣ",
    warning_desc: "Το βάρος σας μπορεί να αποτελεί κίνδυνο για την υγεία.",
    bmi_normal_msg: "Ο ΔΜΣ σας βρίσκεται σε υγιές εύρος. Συνεχίστε τις καλές σας συνήθειες.",
    bmi_overweight_msg: "Ο ΔΜΣ σας είναι πάνω από το συνηθισμένο εύρος. Το πλάνο μας θα σας βοηθήσει βήμα βήμα.",
    bmi_obese_msg: "Ο ΔΜΣ σας είναι υψηλότερος από το προτεινόμενο. Θα σας καθοδηγήσουμε με ένα ασφαλές, προσωπικό πλάνο.",
    lifestyle: { "on-feet":"Δραστήριος", active:"Μέτρια δραστήριος", sitting:"Κυρίως καθιστικός", advanced:"Πολύ δραστήριος", intermediate:"Μέτρια δραστήριος", beginner:"Ήπιος" },
    eater: { balanced:"Ισορροπημένος", sweet:"Λάτρης των γλυκών", salty:"Λάτρης των αλμυρών σνακ", emotional:"Τρώω συναισθηματικά" },
    motivation: { high:"Υψηλό", moderate:"Μέτριο", low:"Χαμηλό" },
  },
  hu: {
    header_label: "Jólléti profil",
    headline: "Íme az Ön személyes profilja",
    lifestyle_label: "Életmód",
    eater_label: "Táplálkozási típus",
    motivation_label: "Motiváció",
    img_alt: "Sportos öltözetű személy",
    warning_title: "Az egészségtelen BMI kockázatai",
    warning_desc: "A testsúly egészségügyi kockázatot jelenthet.",
    bmi_normal_msg: "A BMI-je egészséges tartományban van. Tartsa meg a jó szokásait.",
    bmi_overweight_msg: "A BMI-je a szokásos tartomány felett van. A tervünk lépésről lépésre segít.",
    bmi_obese_msg: "A BMI-je magasabb az ajánlottnál. Biztonságos, személyre szabott tervvel támogatjuk.",
    lifestyle: { "on-feet":"Aktív", active:"Közepesen aktív", sitting:"Többnyire ülő", advanced:"Nagyon aktív", intermediate:"Közepesen aktív", beginner:"Könnyű" },
    eater: { balanced:"Kiegyensúlyozott", sweet:"Édesszájú", salty:"Sós nasi kedvelő", emotional:"Érzelmi evő" },
    motivation: { high:"Magas", moderate:"Közepes", low:"Alacsony" },
  },
  hr: {
    header_label: "Profil dobrobiti",
    headline: "Ovo je vaš osobni profil",
    lifestyle_label: "Način života",
    eater_label: "Tip prehrane",
    motivation_label: "Motivacija",
    img_alt: "Osoba u sportskoj odjeći",
    warning_title: "Rizici nezdravog BMI-ja",
    warning_desc: "Vaša težina može predstavljati rizik za zdravlje.",
    bmi_normal_msg: "Vaš BMI je u zdravom rasponu. Zadržite dobre navike.",
    bmi_overweight_msg: "Vaš BMI je iznad uobičajenog raspona. Naš plan pomoći će vam korak po korak.",
    bmi_obese_msg: "Vaš BMI je viši od preporučenog. Vodit ćemo vas sigurnim, personaliziranim planom.",
    lifestyle: { "on-feet":"Aktivan", active:"Umjereno aktivan", sitting:"Uglavnom sjedilački", advanced:"Vrlo aktivan", intermediate:"Umjereno aktivan", beginner:"Lagano" },
    eater: { balanced:"Uravnotežen", sweet:"Ljubitelj slatkoga", salty:"Ljubitelj slanih grickalica", emotional:"Jedem pod utjecajem emocija" },
    motivation: { high:"Visoka", moderate:"Srednja", low:"Niska" },
  },
  il: {
    header_label: "פרופיל בריאות",
    headline: "זה הפרופיל האישי שלכם",
    lifestyle_label: "אורח חיים",
    eater_label: "דפוס אכילה",
    motivation_label: "מוטיבציה",
    img_alt: "אדם בלבוש ספורטיבי",
    warning_title: "סיכונים של BMI לא תקין",
    warning_desc: "המשקל שלכם עלול להוות סיכון בריאותי.",
    bmi_normal_msg: "ה-BMI שלכם בטווח בריא. המשיכו לשמור על ההרגלים הטובים.",
    bmi_overweight_msg: "ה-BMI שלכם מעל הטווח המקובל. התוכנית שלנו תעזור לכם להשתפר צעד אחר צעד.",
    bmi_obese_msg: "ה-BMI שלכם גבוה מהמומלץ. נלווה אתכם עם תוכנית בטוחה ואישית.",
    lifestyle: { "on-feet":"פעילים", active:"פעילים במידה בינונית", sitting:"יושבים רוב הזמן", advanced:"פעילים מאוד", intermediate:"פעילים במידה בינונית", beginner:"קל" },
    eater: { balanced:"מאוזנים", sweet:"חובבי מתוק", salty:"אוהבי מלוח", emotional:"אוכלים רגשית" },
    motivation: { high:"גבוהה", moderate:"בינונית", low:"נמוכה" },
  },
  jp: {
    header_label: "ウェルネスプロフィール",
    headline: "こちらがあなたのプロフィールです",
    lifestyle_label: "ライフスタイル",
    eater_label: "食のタイプ",
    motivation_label: "モチベーション",
    img_alt: "スポーツウェアを着た人物",
    warning_title: "不健康なBMIのリスク",
    warning_desc: "体重が健康リスクにつながる可能性があります。",
    bmi_normal_msg: "BMIは健康的な範囲です。今の良い習慣を続けましょう。",
    bmi_overweight_msg: "BMIは一般的な範囲より高めです。私たちのプランで少しずつ整えていきましょう。",
    bmi_obese_msg: "BMIは推奨より高めです。安全であなたに合ったプランでサポートします。",
    lifestyle: { "on-feet":"活動的", active:"やや活動的", sitting:"座っている時間が長い", advanced:"とても活動的", intermediate:"やや活動的", beginner:"軽め" },
    eater: { balanced:"バランス型", sweet:"甘い物好き", salty:"しょっぱい物好き", emotional:"気分で食べがち" },
    motivation: { high:"高い", moderate:"普通", low:"低い" },
  },
  ru: {
    header_label: "Профиль самочувствия",
    headline: "Вот ваш персональный профиль",
    lifestyle_label: "Образ жизни",
    eater_label: "Пищевые привычки",
    motivation_label: "Мотивация",
    img_alt: "Человек в спортивной одежде",
    warning_title: "Риски нездорового ИМТ",
    warning_desc: "Ваш вес может создавать риск для здоровья.",
    bmi_normal_msg: "Ваш ИМТ находится в здоровом диапазоне. Сохраняйте свои хорошие привычки.",
    bmi_overweight_msg: "Ваш ИМТ выше обычного диапазона. Наш план поможет вам двигаться вперёд шаг за шагом.",
    bmi_obese_msg: "Ваш ИМТ выше рекомендуемого. Мы проведём вас с помощью безопасного и персонального плана.",
    lifestyle: { "on-feet":"Активный", active:"Умеренно активный", sitting:"Преимущественно сидячий", advanced:"Очень активный", intermediate:"Умеренно активный", beginner:"Лёгкий" },
    eater: { balanced:"Сбалансированный", sweet:"Любит сладкое", salty:"Любит солёные снеки", emotional:"Ест на эмоциях" },
    motivation: { high:"Высокая", moderate:"Средняя", low:"Низкая" },
  },
  sk: {
    header_label: "Profil pohody",
    headline: "Toto je váš osobný profil",
    lifestyle_label: "Životný štýl",
    eater_label: "Typ stravovania",
    motivation_label: "Motivácia",
    img_alt: "Osoba v športovom oblečení",
    warning_title: "Riziká nezdravého BMI",
    warning_desc: "Vaša hmotnosť môže predstavovať zdravotné riziko.",
    bmi_normal_msg: "Vaše BMI je v zdravom rozmedzí. Zachovajte si dobré návyky.",
    bmi_overweight_msg: "Vaše BMI je nad bežným rozmedzím. Náš plán vám pomôže zlepšovať sa krok po kroku.",
    bmi_obese_msg: "Vaše BMI je vyššie, než sa odporúča. Povedieme vás bezpečným a osobným plánom.",
    lifestyle: { "on-feet":"Aktívny", active:"Stredne aktívny", sitting:"Prevažne sedavý", advanced:"Veľmi aktívny", intermediate:"Stredne aktívny", beginner:"Ľahký" },
    eater: { balanced:"Vyvážený", sweet:"Milovník sladkého", salty:"Milovník slaného", emotional:"Jedáva podľa emócií" },
    motivation: { high:"Vysoká", moderate:"Stredná", low:"Nízka" },
  },
  tw: {
    header_label: "健康概況",
    headline: "這是您的個人化概況",
    lifestyle_label: "生活型態",
    eater_label: "飲食類型",
    motivation_label: "動力程度",
    img_alt: "穿著運動服的人物",
    warning_title: "不健康 BMI 的風險",
    warning_desc: "您的體重可能對健康造成風險。",
    bmi_normal_msg: "您的 BMI 落在健康範圍內，請持續保持良好習慣。",
    bmi_overweight_msg: "您的 BMI 高於一般範圍，我們的計畫會一步一步幫助您改善。",
    bmi_obese_msg: "您的 BMI 高於建議範圍，我們會以安全且個人化的方式引導您。",
    lifestyle: { "on-feet":"活躍", active:"中等活躍", sitting:"大多久坐", advanced:"非常活躍", intermediate:"中等活躍", beginner:"輕度" },
    eater: { balanced:"均衡型", sweet:"愛吃甜食", salty:"愛吃鹹食", emotional:"情緒型進食" },
    motivation: { high:"高", moderate:"中", low:"低" },
  }
}
...
const email: Record<LangCode, EmailTranslations> = {
  ...
  lt: { header_label:"2Jūsų planas", headline:"Kur turėtume atsiųsti jūsų planą?", email_label:"El. pašto adresas", placeholder:"Įveskite savo el. paštą", clear_aria:"Išvalyti el. paštą", privacy_note:"Mes gerbiame jūsų privatumą. Perskaitykite mūsų {link}.", privacy_link:"Privatumo politiką" },
...
const quizSteps: Record<LangCode, Record<number, QuizStepT>> = {
  en: {
    1:{ interstitial:{ headline:"Over 21 million people have already chosen a simpler way to move" } },
    2:{ interstitial:{ headline:"Welcome to Tai Chi Coach", body:"You're here to start a simple indoor walking routine you can do without leaving home. Let's learn more about your goals and your needs, so we can create the right plan for you." } },
    3:{ question:"What are your main goals?", subtitle:"You can choose more than one", options:{ "lose-weight":"Lose weight", "heart-health":"Improve heart health", "firm-toned":"Get more toned", "lower-bio-age":"Feel younger and more energized" } },
    4:{ interstitial:{ headline:"Great start — you're on your way.", body:"With Tai Chi Coach, you'll get a guided, personalized approach that adapts to you, so you always know what to do next, without overthinking it.", note:"Results will vary based on your consistency and individual factors." } },
    5:{ question:"How would you describe your body now?", options:{ "mid-sized":"In the middle", heavier:"A bit heavier than I want", overweight:"Much heavier than I want" } },
    6:{ question:"How would you like to feel in your body?", options:{ thin:"Lighter and more comfortable", toned:"More toned and a bit stronger", curvy:"Balanced and confident in my shape" } },
    7:{ question:"Which parts of your body would you like to improve?", subtitle:"You can choose more than one", options:{ arms:"Arms", abs:"Abs", booty:"Hips & glutes", legs:"Legs" } },
    8:{ question:"When did you last feel in your best shape?", options:{ "less-1yr":"Less than 1 year ago", "1-2yr":"1–2 years ago", "over-3yr":"More than 3 years ago", never:"I have never felt that way" } },
    9:{ interstitial:{ headline:"You're doing great!", body:"Many people worry that they are not good enough. We understand this, and we will keep it in mind when we create your plan, so you can feel more confident as you go." } },
    10:{ question:"How active are you right now?", options:{ advanced:"Very active", intermediate:"Somewhat active", beginner:"Just starting" } },
    11:{ question:"How flexible is your body?", options:{ "very-flexible":"Quite flexible", "some-flexible":"A little flexible", "not-flexible":"Not very flexible", "unsure-flexible":"I'm not sure" } },
    12:{ question:"How often do you exercise?", options:{ daily:"Almost every day", weekly:"A few times per week", monthly:"A few times per month" } },
    13:{ question:"How do you feel after walking up stairs?", options:{ breathless:"I feel out of breath", winded:"I feel a bit tired, but okay", fine:"I feel fine after one flight", easy:"I can easily climb several flights" } },
    14:{ question:"How regularly do you go walking?", options:{ daily:"Nearly every day", weekly:"A few times during the week", monthly:"Rarely (around once a month)" } },
    15:{ question:"Do you have any pain or discomfort in your body?", subtitle:"You can choose more than one", options:{ back:"Back pain", knees:"Knee pain", elbows:"Elbow pain", none:"No problems" } },
    16:{ question:"What does your daily schedule look like?", options:{ "9to5":"I have a fixed daytime schedule", nights:"I work night shifts", flexible:"My hours are flexible", retired:"I am retired" } },
    17:{ question:"What does your day usually look like?", options:{ "on-feet":"I move a lot during the day", active:"I move sometimes during breaks", sitting:"I sit most of the day" } },
    18:{ question:"How long do you sleep at night?", options:{ "less-5":"Under 5 hours", "5-6":"5–6 hours", "7-8":"7–8 hours", "over-9":"Over 8 hours" } },
    19:{ question:"How much water do you drink each day?", options:{ "less-2":"About 1–2 glasses", "2-6":"Around 3–5 glasses", "6-8":"6 or more glasses", "over-8":"I mostly drink coffee or tea" } },
    20:{ question:"Do you have any habits you want to improve?", subtitle:"You can choose more than one", options:{ sleep:"I don't sleep enough", sugar:"I eat too much sugar", soda:"I drink a lot of soda", salty:"I eat a lot of salty food", snacker:"I eat late at night", none:"None of these" } },
    21:{ question:"Have any life changes affected your weight?", subtitle:"You can choose more than one", options:{ marriage:"Relationship or marriage", work:"Busy work or daily routine", stress:"Stress or emotional health", pregnancy:"Pregnancy", meds:"Medication or hormones", none:"None of these" } },
    22:{ interstitial:{ headline:"Small changes can make a big difference", body:"Many people gain weight after life changes. You are not alone. We will guide you and support you on your journey." } },
    23:{ question:"Enter your height", placeholder:"e.g. 168", hintTitle:"Calculating your body mass index", hint:"BMI is widely used as a risk factor for the development or prevalence of several health issues." },
    24:{ question:"Tell us your current weight", placeholder:"e.g. 165" },
    25:{ question:"What weight would you like to reach?", placeholder:"e.g. 140" },
    26:{ question:"What is your age?", placeholder:"e.g. 35", hint:"We use this to make your plan more personal.", buttonLabel:"Next" },
    27:{ question:"Enter your name", placeholder:"Your name" },
    28:{ interstitial:{ headline:"Personalized indoor walking with Tai Chi Coach", body:"Tai Chi Coach combines gentle walking at home with simple Tai Chi-based movement. Your plan is personalized to fit your body, your needs, and your daily life — so you can move safely, stay consistent, and feel better over time." } },
    29:{ question:"Do you have any upcoming event that motivates you to lose weight?", options:{ vacation:"Holiday or trip", "sporting-event":"Sports activity", "beach-trip":"Trip to the beach", wedding:"Wedding", "family-occasion":"Family event", reunion:"Meeting people (reunion)", none:"No special plans" } },
    30:{ question:"When is your event?", subtitle:"This helps us create a plan that fits your timeline and goals. Your information is private and will not be shared." }
  },
  lt: {
    1:{ interstitial:{ headline:"Daugiau nei 21 milijonas žmonių jau pasirinko paprastesnį būdą judėti" } },
    2:{ interstitial:{ headline:"Sveiki atvykę į Tai Ci treneris", body:"Jūs čia tam, kad pradėtumėte paprastą ėjimo namuose rutiną. Sužinokime daugiau apie jūsų tikslus ir poreikius, kad galėtume sukurti jums tinkamą planą." } },
    ...
    4:{ interstitial:{ headline:"Puiki pradžia, jūs jau pakeliui.", body:"Su Tai Ci treneris gausite aiškų, asmeniškai pritaikytą planą, kuris prisitaiko prie jūsų, kad visada žinotumėte, ką daryti toliau.", note:"Rezultatai priklauso nuo nuoseklumo ir individualių veiksnių." } },
    ...
    28:{ interstitial:{ headline:"Asmeniškai pritaikytas ėjimas namuose su Tai Ci treneris", body:"Tai Ci treneris sujungia švelnų ėjimą namuose su paprastais Tai Chi judesiais. Jūsų planas pritaikomas jūsų kūnui, poreikiams ir kasdieniam ritmui, kad galėtumėte judėti saugiai ir nuosekliai." } },
  ...
  lv: {
    ...
    2:{ interstitial:{ headline:"Laipni lūdzam Tai Ci treneris", body:"Jūs esat šeit, lai sāktu vienkāršu pastaigu telpās rutīnu, ko var darīt mājās. Uzzināsim vairāk par jūsu mērķiem un vajadzībām, lai izveidotu jums piemērotu plānu." } },
    ...
    4:{ interstitial:{ headline:"Lielisks sākums, jūs jau esat ceļā.", body:"Ar Tai Ci treneris jūs saņemsiet skaidru, personalizētu pieeju, kas pielāgojas jums, lai vienmēr zinātu, ko darīt tālāk.", note:"Rezultāti būs atkarīgi no regularitātes un individuāliem faktoriem." } },
    ...
    28:{ interstitial:{ headline:"Personalizētas pastaigas telpās ar Tai Ci treneris", body:"Tai Ci treneris apvieno saudzīgas pastaigas mājās ar vienkāršām Tai Chi kustībām. Jūsu plāns tiek pielāgots jūsu ķermenim, vajadzībām un ikdienai, lai jūs varētu kustēties droši un regulāri." } },
  ...
  ro: {
    ...
    2:{ interstitial:{ headline:"Bine ați venit la Antrenorul de Tai Chi", body:"Sunteți aici pentru a începe o rutină simplă de mers în interior, pe care o puteți face acasă. Haideți să aflăm mai multe despre obiectivele și nevoile dumneavoastră, ca să creăm planul potrivit." } },
    ...
    4:{ interstitial:{ headline:"Un început excelent, sunteți pe drumul cel bun.", body:"Cu Antrenorul de Tai Chi veți primi o abordare ghidată și personalizată, adaptată dumneavoastră, astfel încât să știți mereu ce urmează.", note:"Rezultatele variază în funcție de consecvență și de factorii individuali." } },
    ...
    28:{ interstitial:{ headline:"Mers în interior personalizat cu Antrenorul de Tai Chi", body:"Antrenorul de Tai Chi combină mersul blând acasă cu mișcări simple inspirate din Tai Chi. Planul dumneavoastră este adaptat corpului, nevoilor și ritmului de zi cu zi, astfel încât să vă mișcați în siguranță și constant." } },
  ...
  cz: {
    ...
    2:{ interstitial:{ headline:"Vítejte v Tai Chi kouč", body:"Jste tu proto, abyste začali s jednoduchou domácí chůzí, kterou zvládnete bez odchodu z domu. Pojďme zjistit více o vašich cílech a potřebách, abychom pro vás vytvořili správný plán." } },
    ...
    4:{ interstitial:{ headline:"Skvělý začátek, jste na dobré cestě.", body:"S Tai Chi kouč získáte vedený a osobní přístup, který se přizpůsobí vám, takže budete vždy vědět, co dělat dál.", note:"Výsledky se liší podle pravidelnosti a individuálních faktorů." } },
    ...
    28:{ interstitial:{ headline:"Osobní domácí chůze s Tai Chi kouč", body:"Tai Chi kouč kombinuje jemnou domácí chůzi s jednoduchými pohyby inspirovanými Tai Chi. Váš plán je přizpůsoben vašemu tělu, potřebám i běžnému dni, abyste se mohli hýbat bezpečně a pravidelně." } },
  ...
  dk: {
    ...
    2:{ interstitial:{ headline:"Velkommen til Tai Chi-coach", body:"I er her for at starte en enkel indendørs gå-rutine, som kan klares derhjemme. Lad os lære mere om jeres mål og behov, så vi kan skabe den rigtige plan." } },
    ...
    4:{ interstitial:{ headline:"Fantastisk start, I er godt på vej.", body:"Med Tai Chi-coach får I en guidet, personlig tilgang, som tilpasser sig jer, så I altid ved, hvad næste skridt er.", note:"Resultater varierer afhængigt af regelmæssighed og individuelle forhold." } },
    ...
    28:{ interstitial:{ headline:"Personlig indendørs gang med Tai Chi-coach", body:"Tai Chi-coach kombinerer blid gang derhjemme med enkle Tai Chi-inspirerede bevægelser. Planen tilpasses jeres krop, behov og hverdag, så I kan bevæge jer sikkert og holde fast i rutinen." } },
  ...
  gr: {
    ...
    2:{ interstitial:{ headline:"Καλώς ήρθατε στο Προπονητής Tai Chi", body:"Είστε εδώ για να ξεκινήσετε μια απλή ρουτίνα περπατήματος στο σπίτι. Ας μάθουμε περισσότερα για τους στόχους και τις ανάγκες σας, ώστε να δημιουργήσουμε το σωστό πλάνο για εσάς." } },
    ...
    4:{ interstitial:{ headline:"Εξαιρετική αρχή, είστε ήδη στον σωστό δρόμο.", body:"Με το Προπονητής Tai Chi θα έχετε μια καθοδηγούμενη, προσωπική προσέγγιση που προσαρμόζεται σε εσάς, ώστε να ξέρετε πάντα ποιο είναι το επόμενο βήμα.", note:"Τα αποτελέσματα διαφέρουν ανάλογα με τη συνέπεια και τους προσωπικούς παράγοντες." } },
  ...
  hu: {
    ...
    2:{ interstitial:{ headline:"Üdvözli a Tai Chi edző", body:"Azért vannak itt, hogy elindítsanak egy egyszerű, otthon is végezhető sétarutint. Nézzük meg közelebbről a céljaikat és az igényeiket, hogy a megfelelő tervet készíthessük el." } },
    ...
    4:{ interstitial:{ headline:"Remek kezdés, jó úton haladnak.", body:"A Tai Chi edző irányított, személyre szabott megközelítést ad, amely Önökhöz igazodik, így mindig tudni fogják, mi következik.", note:"Az eredmények a rendszerességtől és az egyéni tényezőktől függnek." } },
    ...
    28:{ interstitial:{ headline:"Személyre szabott otthoni séta a Tai Chi edző segítségével", body:"A Tai Chi edző az otthoni, kíméletes sétát egyszerű Tai Chi ihletésű mozdulatokkal ötvözi. A terv a testükhöz, az igényeikhez és a mindennapjaikhoz igazodik, hogy biztonságosan és következetesen tudjanak haladni." } },
  ...
  hr: {
    ...
    2:{ interstitial:{ headline:"Dobrodošli u Tai Chi trener", body:"Ovdje ste kako biste započeli jednostavnu rutinu hodanja kod kuće. Upoznajmo vaše ciljeve i potrebe kako bismo izradili plan koji vam stvarno odgovara." } },
    ...
    4:{ interstitial:{ headline:"Odličan početak, na pravom ste putu.", body:"Uz Tai Chi trener dobit ćete vođeni, personalizirani pristup koji se prilagođava vama, tako da uvijek znate što je sljedeći korak.", note:"Rezultati ovise o vašoj dosljednosti i individualnim čimbenicima." } },
    ...
    28:{ interstitial:{ headline:"Personalizirano hodanje u zatvorenom uz Tai Chi trener", body:"Tai Chi trener spaja lagano hodanje kod kuće s jednostavnim pokretima inspiriranima Tai Chijem. Vaš plan prilagođen je vašem tijelu, potrebama i svakodnevici kako biste se mogli kretati sigurno i dosljedno." } },
  ...
  il: {
    ...
    2:{ interstitial:{ headline:"ברוכים הבאים ל-מאמן טאי צ׳י", body:"אתם כאן כדי להתחיל שגרת הליכה פשוטה בבית, בלי צורך לצאת החוצה. בואו נבין טוב יותר את המטרות והצרכים שלכם, כדי שנוכל לבנות את התוכנית הנכונה." } },
    ...
    4:{ interstitial:{ headline:"התחלה מצוינת, אתם בדרך הנכונה.", body:"עם מאמן טאי צ׳י תקבלו גישה מונחית ואישית שמתאימה את עצמה אליכם, כך שתמיד תדעו מה הצעד הבא.", note:"התוצאות משתנות בהתאם לעקביות ולגורמים אישיים." } },
    ...
    28:{ interstitial:{ headline:"הליכה ביתית מותאמת אישית עם מאמן טאי צ׳י", body:"מאמן טאי צ׳י משלב הליכה עדינה בבית עם תנועות פשוטות בהשראת טאי צ׳י. התוכנית מותאמת לגוף שלכם, לצרכים שלכם ולשגרת היום, כך שתוכלו לזוז בבטחה ובהתמדה." } },
  ...
  jp: {
    ...
    2:{ interstitial:{ headline:"太極拳コーチへようこそ", body:"ご自宅で無理なく続けられる、シンプルな室内ウォーキング習慣を始めるために来ていただきました。目標やお悩みを知ることで、あなたに合ったプランを作成できます。" } },
    ...
    4:{ interstitial:{ headline:"とても良いスタートです。このまま進みましょう。", body:"太極拳コーチでは、あなたに合わせて調整されるガイド付きのプランで、次に何をすればよいか迷わず進めます。", note:"結果には継続度や個人差があります。" } },
    ...
    28:{ interstitial:{ headline:"太極拳コーチで始める、あなた専用の室内ウォーキング", body:"太極拳コーチは、自宅でのやさしいウォーキングとシンプルなTai Chiの動きを組み合わせています。体や生活に合わせて調整されるので、安全に、無理なく、続けやすくなります。" } },
  ...
  ru: {
    ...
    2:{ interstitial:{ headline:"Добро пожаловать в Тайцзи-тренер", body:"Вы здесь, чтобы начать простую домашнюю программу ходьбы, которую можно выполнять не выходя из дома. Давайте узнаем больше о ваших целях и потребностях, чтобы составить подходящий план." } },
    ...
    4:{ interstitial:{ headline:"Отличное начало, вы на верном пути.", body:"С Тайцзи-тренер вы получите понятный и персональный подход, который подстраивается под вас, чтобы вы всегда знали, что делать дальше.", note:"Результаты зависят от вашей регулярности и индивидуальных факторов." } },
    ...
    28:{ interstitial:{ headline:"Персональная ходьба дома с Тайцзи-тренер", body:"Тайцзи-тренер сочетает мягкую домашнюю ходьбу с простыми движениями на основе Тай Чи. Ваш план учитывает ваше тело, ваши потребности и ваш ритм жизни, чтобы вы могли двигаться безопасно и регулярно." } },
  ...
  sk: {
    ...
    2:{ interstitial:{ headline:"Vitajte v Tai Chi kouč", body:"Ste tu preto, aby ste začali jednoduchú domácu rutinu chôdze, ktorú zvládnete bez odchodu z domu. Poďme sa pozrieť na vaše ciele a potreby, aby sme vytvorili správny plán." } },
    ...
    4:{ interstitial:{ headline:"Skvelý začiatok, ste na dobrej ceste.", body:"S Tai Chi kouč získate vedený a osobný prístup, ktorý sa prispôsobí vám, aby ste vždy vedeli, čo urobiť ďalej.", note:"Výsledky sa líšia podľa pravidelnosti a individuálnych faktorov." } },
    ...
    28:{ interstitial:{ headline:"Personalizovaná domáca chôdza s Tai Chi kouč", body:"Tai Chi kouč spája jemnú domácu chôdzu s jednoduchými pohybmi inšpirovanými Tai Chi. Váš plán sa prispôsobuje vášmu telu, potrebám aj každodennému rytmu, aby ste sa mohli hýbať bezpečne a pravidelne." } },
  ...
  tw: {
    ...
    2:{ interstitial:{ headline:"歡迎來到 太極教練", body:"您來到這裡，是為了開始一套簡單、在家就能進行的室內步行習慣。讓我們先了解您的目標與需求，好為您建立真正適合的計畫。" } },
    3:{ question:"您的主要目標是什麼？", subtitle:"可複選", options:{ "lose-weight":"減重", "heart-health":"改善心臟健康", "firm-toned":"讓身形更緊實", "lower-bio-age":"感覺更年輕、更有精神" } },
    4:{ interstitial:{ headline:"很好的開始，您已經走在正確的路上。", body:"透過 太極教練，您將獲得一套會依照您狀況調整的個人化引導方式，讓您清楚知道下一步該做什麼。", note:"結果會依個人狀況與持續程度而有所不同。" } },
    ...
    28:{ interstitial:{ headline:"使用 太極教練 的個人化室內步行", body:"太極教練 結合在家即可進行的溫和步行與簡單的 Tai Chi 動作。您的計畫會依照身體狀況、需求與日常生活節奏調整，讓您能安心且持續地動起來。" } },
